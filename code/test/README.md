...
Open your terminal and navigate to the test folder:
`cd code/test`

To compile the specific test executable (run_test), simply run: 
`make`
...
Depending on your needs, you can perform a partial or full cleanup of the directory:
only object files:
`clean`
