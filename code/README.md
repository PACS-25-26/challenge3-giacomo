...
* 'jacobi_solver.hpp' contains a class that is called **JacobiSolver** and deal with the parallel implementation of the Jaacobi iteration method.
* 'utils.hpp' contains the implementation of useful tools for other parts of the code;
...
* 'forcing_parser.hpp' implements a functor that using muParser dynamically evaluate string-based math expressions. It leverages thread_local instances for OpenMP compatibility and features MPI-aware error logging for parallel environments;
